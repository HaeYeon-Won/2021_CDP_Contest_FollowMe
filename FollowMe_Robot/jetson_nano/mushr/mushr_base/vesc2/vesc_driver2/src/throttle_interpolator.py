...
class InterpolateThrottle:
    def __init__(self):
        ...
        self.rpm_input_topic   = rospy.get_param('~rpm_input_topic', '/vesc2/commands/motor/unsmoothed_speed')
        self.rpm_output_topic  = rospy.get_param('~rpm_output_topic', '/vesc2/commands/motor/speed')

        self.servo_input_topic   = rospy.get_param('~servo_input_topic', '/vesc2/commands/servo/unsmoothed_position')
        self.servo_output_topic  = rospy.get_param('~servo_output_topic', '/vesc2/commands/servo/position')

        self.max_acceleration = rospy.get_param('/vesc2/max_acceleration')
        self.max_rpm = rospy.get_param('/vesc2/vesc_driver2/speed_max')
        self.min_rpm = rospy.get_param('/vesc2/vesc_driver2/speed_min')
        self.throttle_smoother_rate = rospy.get_param('/vesc2/throttle_smoother_rate')
        self.speed_to_erpm_gain = rospy.get_param('/vesc2/speed_to_erpm_gain')

        self.max_servo_speed = rospy.get_param('/vesc2/max_servo_speed')
        self.steering_angle_to_servo_gain = rospy.get_param('/vesc2/steering_angle_to_servo_gain')
        self.servo_smoother_rate = rospy.get_param('/vesc2/servo_smoother_rate')
        self.max_servo = rospy.get_param('/vesc2/vesc_driver2/servo_max')
        self.min_servo = rospy.get_param('/vesc2/vesc_driver2/servo_min')

        # Variables
        self.last_rpm = 0
        self.desired_rpm = self.last_rpm

        self.last_servo = rospy.get_param('/vesc2/steering_angle_to_servo_offset')
