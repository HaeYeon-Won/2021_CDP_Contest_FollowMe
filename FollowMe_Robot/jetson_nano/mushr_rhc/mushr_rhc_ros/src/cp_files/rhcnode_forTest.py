...
class RHCNode(rhcbase.RHCBase):
    ...
    # if out of range in first_state_list, change second_state_list and
    # change list
    def change_count(self, data):
        global count
        count = data.data
        print ("count = ", count)
        if (data.data == 0):
    ...
    def start(self):
        ...
        #=================================[edit]====================================#
        # publish map count to pub_changemap.py
        #pub = rospy.Publisher("map_count", Int32, queue_size=2)
        # publish map count to from_pi.py
        pub_pi = rospy.Publisher("count", Int32, queue_size=2)
        #pub_avd = rospy.Publisher("TF_state", String, queue_size=2)
        # subscribe "out of range in map list" from from_pi.py
        sub_pi = rospy.Subscriber("Change_map", Int32, self.change_count)
        #===========================================================================#
        self.start_profile()
        self.setup_pub_sub()
        ...
        self.ack_atgoal.publish(1) #atgoal pub!!!!!!!!!
        #=================================[edit]====================================#
        i = 0
        srv_map = rospy.ServiceProxy('srv_map', MapandGoal)
        res = srv_map(i)
        #pub_pi.publish(0)
        # how to node kill
        #os.system("rosnode kill /pub_changemap")
        #os.system("rosnode kill /sub_changemap")
        #os.system("roslaunch changemap sub_pub_restart.launch")
        #===========================================================================#
        #==================================[edit]===================================#
        time.sleep(5)
        i = 1
        ...
        if count == 1111:
            ...
            if count != 1111:
                os.system ("roslaunch changemap rhc_pf_sub_pub_start.launch")
        #===========================================================================#
    ...
    def setup_pub_sub(self):
        ...
        self.ack_atgoal = rospy.Publisher("ACK_atgoal",Int32,queue_size=1)
