...
class RHCBase(object):
    ...
    def load_controller(self):
        self.logger.info("load_controller")
        m = self.get_model()
    ...
    def get_cost_fn(self):
        ...
        self.logger.info(self.map_data.origin_x)
    ...
    def cb_map_metadata(self, msg):
        self.logger.info("cb_map_metadata")
